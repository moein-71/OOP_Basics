...
Patient::Patient(const std::string & name , int age , int height , int weight , const Vital_signs & patient) : name(name) , age(age) , height(height) , weight(weight) 
{
...
int Patient::get_height() const
{
    return this -> height ;
}

int Patient::get_weight() const
{
    return this -> weight ;
}

Vital_signs Patient::get_vital_signs() const
{
    return this -> patient ;
}
